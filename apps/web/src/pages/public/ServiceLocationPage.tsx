...
import {
  PROVIDERS, FUNDING_OPTIONS, LANGUAGE_OPTIONS, COMPARE, DEMAND, METHOD,
...
// Same illustrative scale used in the LOCATION_GROUPS data on the
// homepage — kept consistent rather than inventing a second set of
// placeholder numbers.
...
// Same treatment for illustrative median response minutes, keyed by
// the same state abbreviations as STATE_COVERAGE above.
    ...
    <>
        ...
        <div className="svc-hero-card">
          ...
          <div className="svc-hero-grid">
            ...
            <div className="svc-hero-panel">
              ...
              <button
                className="btn-gradient svc-hero-search-btn"
      ...
      <div className="svc-body">
        ...
        <main className="svc-main">
          ...
          <section id="directory-stats" className="svc-stats-band">
            <div className="svc-stats-band-grid">
              <div>
                <p className="svc-stats-band-value"><Counter value={PROVIDERS.length * 32} />+</p>
                <p className="svc-stats-band-label">Providers in the directory</p>
              </div>
              <div>
                <p className="svc-stats-band-value"><Counter value={1890} /></p>
                <p className="svc-stats-band-label">Suburbs covered nationally</p>
              </div>
              <div>
                <p className="svc-stats-band-value"><Counter value={73} /></p>
                <p className="svc-stats-band-label">Requests behind the demand data above</p>
              </div>
            </div>
            <p className="svc-footnote" style={{ marginTop: 18 }}>
              Figures shown are illustrative placeholders for this build — see the
              note at the top of this file before publishing real numbers here.
            </p>
          </section>
          ...
          <section id="credentials">
            ...
            <ol className="svc-credentials-list">
              <li>
                <span className="svc-credentials-num">1</span>
                <div>
                  <p className="svc-credentials-title">NDIS registration</p>
                  <p className="svc-credentials-body">Ask for their registration number and check it against the NDIS Commission's public register — a listing here isn't proof on its own.</p>
                </div>
              </li>
              <li>
                <span className="svc-credentials-num">2</span>
                <div>
                  <p className="svc-credentials-title">Insurance</p>
                  <p className="svc-credentials-body">Ask to see current public liability and professional indemnity certificates, not just a claim that they're covered.</p>
                </div>
              </li>
              <li>
                <span className="svc-credentials-num">3</span>
                <div>
                  <p className="svc-credentials-title">Qualifications</p>
                  <p className="svc-credentials-body">For clinical or trade work, ask which specific staff member is assigned and what their relevant qualification is.</p>
                </div>
              </li>
              <li>
                <span className="svc-credentials-num">4</span>
                <div>
                  <p className="svc-credentials-title">Experience</p>
                  <p className="svc-credentials-body">Ask how long they've delivered this exact service, and for a reference from a recent, comparable job if you can.</p>
                </div>
              </li>
              <li>
                <span className="svc-credentials-num">5</span>
                <div>
                  <p className="svc-credentials-title">Compliance</p>
                  <p className="svc-credentials-body">Ask about their worker screening status and how they handle incidents or complaints — a registered provider must have a documented process.</p>
                </div>
              </li>
            </ol>
          </section>
          ...
          <section id="find-near-you" className="svc-finder">
            ...
            <p className="svc-p svc-p-tight">Search a different suburb or service — this updates the whole page.</p>
            <form
              className="svc-finder-form"
              onSubmit={(e) => {
                e.preventDefault();
                navigate(`/services/${slugify(finderServiceInput)}/${slugify(finderLocationInput)}`);
              }}
            >
              <label className="svc-finder-field">
                <span>Location</span>
                <input
                  value={finderLocationInput}
                  onChange={(e) => setFinderLocationInput(e.target.value)}
              ...
              <button type="submit" className="btn-gradient svc-finder-btn">
                Search →
              </button>
            </form>
          </section>
          ...
          <section id="response-by-state">
            ...
            <p className="svc-p svc-p-tight">Median time to a provider's first reply, by state.</p>
            <div className="svc-bar-list">
              {(() => {
                ...
                return RESPONSE_BY_STATE.map((r) => (
                  <div key={r.abbr}>
                    <div className="svc-bar-row">
                      <span>{r.abbr}</span>
                      <span className="svc-bar-pct">{r.minutes} min</span>
                    </div>
      ...
      {/* Need support at home? — strong closing CTA */}
      <section className="svc-cta-band">
        <div className="svc-cta-band-inner">
          ...
          <div className="svc-cta-band-actions">
            <button className="btn-gradient btn-lg" onClick={() => document.getElementById('providers')?.scrollIntoView({ behavior: 'smooth' })}>
              Find providers
            </button>
            <button className="svc-cta-band-secondary" onClick={() => document.getElementById('match')?.scrollIntoView({ behavior: 'smooth' })}>
              Get matched
            </button>
          </div>
        </div>
        ...
        <div className="svc-related-inner">
          ...
          <div className="svc-related-grid">
            {OTHER_SERVICES.map((name) => (
              <Link key={name} to={`/services/${slugify(name)}/${suburbSlug}`} className="svc-related-link">
                {name}
              </Link>
            ))}
          </div>
